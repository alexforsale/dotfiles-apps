...
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 xresources["*.background"], stop:1 xresources["*.color18"])'
...
c.colors.completion.item.selected.fg = xresources["*.color20"]
c.colors.completion.item.selected.match.fg = xresources["*.color1"]
c.colors.completion.match.fg = xresources["*.color20"]
...
c.colors.statusbar.command.private.fg = xresources["*.color20"]
...
c.colors.statusbar.private.fg = xresources["*.color20"]
c.colors.statusbar.progress.bg = xresources["*.color13"]
c.colors.statusbar.url.error.fg = xresources["*.color16"]
...
c.colors.tabs.bar.bg = xresources["*.color18"]
c.colors.tabs.even.bg = xresources["*.color18"]
...
c.colors.tabs.odd.bg = xresources["*.color18"]
c.colors.tabs.odd.fg = xresources["*.foreground"]
c.colors.tabs.pinned.even.bg = xresources['*.color18']
c.colors.tabs.pinned.even.fg = xresources["*.foreground"]
c.colors.tabs.pinned.odd.bg = xresources['*.color18']
c.colors.tabs.pinned.odd.fg = xresources["*.foreground"]
c.colors.tabs.pinned.selected.even.bg = xresources['*.color19']
c.colors.tabs.pinned.selected.even.fg = xresources["*.color15"]
c.colors.tabs.pinned.selected.odd.bg = xresources['*.color19']
c.colors.tabs.pinned.selected.odd.fg = xresources["*.color15"]
c.colors.tabs.selected.even.bg = xresources['*.color19']
c.colors.tabs.selected.even.fg = xresources["*.color15"]
c.colors.tabs.selected.odd.bg = xresources['*.color19']
...
config.set('content.headers.user_agent', 'content.headers.user_agent "Mozilla/5.0 ({os_info}; rv:90.0) Gecko/20100101 Firefox/90.0', 'https://accounts.google.com/*')
...
config.bind("Cr", "open javascript:location.href='org-protocol://roam-ref?template=r&ref='+encodeURIComponent(location.href)+'&title='+encodeURIComponent(document.title)")

config.bind("Cl", "open javascript:location.href='org-protocol://capture?template=l&url='+encodeURIComponent(location.href)+'&title='+encodeURIComponent(document.title)")
...
c.fonts.default_family = [ "Source Code Pro", "Source Sans Pro",
                           "Source Serif Pro", "Fantasque Sans Mono",
